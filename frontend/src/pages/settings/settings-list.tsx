...
const SettingsTablesPage = () => {
  ...
  const [filters] = useState([
    { label: 'Database User', title: 'Database_user' },
    { label: 'Database Password', title: 'Database_Password' },
    { label: 'Database Port', title: 'Database_Port' },
    { label: 'Databose Host', title: 'Databose_Host' },
  ]);

  const hasCreatePermission =
    currentUser && hasPermission(currentUser, 'CREATE_SETTINGS');
