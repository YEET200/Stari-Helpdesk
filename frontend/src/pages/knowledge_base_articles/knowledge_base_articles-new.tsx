...
import { create } from '../../stores/knowledge_base_articles/knowledge_base_articlesSlice';
...
const Knowledge_base_articlesNew = () => {
...
Knowledge_base_articlesNew.getLayout = function getLayout(page: ReactElement) {
  return (
    <LayoutAuthenticated permission={'CREATE_KNOWLEDGE_BASE_ARTICLES'}>
      {page}
    </LayoutAuthenticated>
  );
};

export default Knowledge_base_articlesNew;
