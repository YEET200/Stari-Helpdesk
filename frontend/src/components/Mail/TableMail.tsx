...
import {
  ...
  deleteItem,
  setRefetch,
} from '../../stores/mail/mailSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureMailCols';
...
const TableSampleMail = ({ filterItems, setFilterItems, filters }) => {
  ...
  useEffect(() => {
    if (mailNotify.showNotification) {
      notify(mailNotify.typeNotification, mailNotify.textNotification);
    }
  }, [mailNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/mail/mail-view/?id=${id}`);
  };
...
export default TableSampleMail;
