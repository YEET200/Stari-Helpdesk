...
const ListCommunity_forum_posts = ({
  ...
  return (
    <>
      <div className='relative overflow-x-auto p-4 space-y-4'>
        ...
        {!loading &&
          community_forum_posts.map((item) => (
              ...
              <div className={'flex items-center overflow-hidden'}>
                ...
                >
                  ...
                  <div className={'flex-1 px-3'}>
                    ...
                    <p className={'line-clamp-2'}>
                      {dataFormatter.usersOneListFormatter(item.moderator)}
                    </p>
                  </div>
                </div>
                <ListActionsPopover
        ...
        {!loading && community_forum_posts.length === 0 && (
...
export default ListCommunity_forum_posts;
