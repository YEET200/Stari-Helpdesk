              ...
              <div className={'flex items-center overflow-hidden'}>
                ...
                >
                  <div className={'flex-1 px-3'}>
                    ...
                    <p className={'line-clamp-2'}>{item.Database_user}</p>
                  </div>

                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs text-gray-500'}>Database Password</p>
                    <p className={'line-clamp-2'}>{item.Database_Password}</p>
                  </div>

                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs text-gray-500'}>Database Port</p>
                    <p className={'line-clamp-2'}>{item.Database_Port}</p>
                  </div>

                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs text-gray-500'}>Databose Host</p>
                    <p className={'line-clamp-2'}>{item.Databose_Host}</p>
                  </div>
                </div>
                <ListActionsPopover
                  onDelete={onDelete}
