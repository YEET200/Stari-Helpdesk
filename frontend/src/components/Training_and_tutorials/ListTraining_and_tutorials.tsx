...
const ListTraining_and_tutorials = ({
  ...
  return (
    <>
      <div className='relative overflow-x-auto p-4 space-y-4'>
        ...
        {!loading &&
          training_and_tutorials.map((item) => (
        ...
        {!loading && training_and_tutorials.length === 0 && (
...
export default ListTraining_and_tutorials;
