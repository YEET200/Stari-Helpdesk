...
import {
  ...
  deleteItem,
  setRefetch,
} from '../../stores/downloads/downloadsSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureDownloadsCols';
...
const TableSampleDownloads = ({ filterItems, setFilterItems, filters }) => {
  ...
  const {
    ...
    loading,
    count,
    notify: downloadsNotify,
    refetch,
  } = useAppSelector((state) => state.downloads);
  ...
  useEffect(() => {
    if (downloadsNotify.showNotification) {
      notify(
        downloadsNotify.typeNotification,
        downloadsNotify.textNotification,
      );
    }
  }, [downloadsNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/downloads/downloads-view/?id=${id}`);
  };
...
export default TableSampleDownloads;
