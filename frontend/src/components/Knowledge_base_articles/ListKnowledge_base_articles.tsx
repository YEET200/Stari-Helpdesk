...
const ListKnowledge_base_articles = ({
  ...
  return (
    <>
      <div className='relative overflow-x-auto p-4 space-y-4'>
        ...
        {!loading &&
          knowledge_base_articles.map((item) => (
        ...
        {!loading && knowledge_base_articles.length === 0 && (
...
export default ListKnowledge_base_articles;
