  ...
  static async search(searchQuery, currentUser) {
    try {
      ...
      const tableColumns = {
        ...
        community_forum_posts: ['title', 'content'],

        downloads: ['title'],

        feedback_and_surveys: ['title', 'content'],

        knowledge_base_articles: ['title', 'content'],

        organizations: ['name', 'description'],

        support_tickets: ['title', 'description', 'comments'],

        training_and_tutorials: ['title', 'description'],
